  ...
  <div class="max-w-4xl mx-auto py-20">
    ...
    <div class="mb-16">
      ...
      <div class="mb-8">
        ...
        <div class="bg-gray-800 h-56 w-full rounded-lg mb-4"></div>
        <p class="text-lg text-gray-400">
          Analyzed existing lightweight browsers to identify best practices and opportunities for innovation.
        </p>
      </div>
      ...
      <div class="mb-8">
        ...
        <div class="bg-gray-800 h-56 w-full rounded-lg mb-4"></div>
        <p class="text-lg text-gray-400">
          Created low-fidelity wireframes and interactive prototypes to test core functionality and navigation concepts.
        </p>
      </div>
      ...
      <div>
        ...
        <div class="bg-gray-800 h-56 w-full rounded-lg mb-4"></div>
        <p class="text-lg text-gray-400">
          Conducted multiple rounds of usability testing with target users, iterating on the design based on feedback.
        </p>
      </div>
    </div>
    ...
    <div class="mb-16">
      ...
      <p class="text-lg text-gray-400 mb-4">
        The redesigned FirefoxLite browser achieved a 40% reduction in data usage and 30% decrease in 
        memory consumption compared to standard browsers, while maintaining core functionality.
      </p>
      <p class="text-lg text-gray-400">
    ...
    <div class="mb-16">
      ...
      <p class="text-lg text-gray-400">
        This project emphasized the importance of understanding specific user contexts and technological 
        constraints when designing digital products. It also highlighted how thoughtful feature prioritization 
        can create meaningful experiences even with significant technical limitations.
      </p>
    </div>
    
    <div class="flex justify-between items-center pt-8 border-t border-gray-800">
      <RouterLink to="/project-a" class="text-gray-400 hover:text-white transition">← Previous Project</RouterLink>
      <RouterLink to="/project-c" class="text-gray-400 hover:text-white transition">Next Project →</RouterLink>
    </div>
  </div>
</template> 